...
const labels = {dashboard:'Dashboard',customers:'Clientes',quotes:'Orçamentos',projects:'Projetos',products:'Produtos',categories:'Serviços',users:'Usuários',activities:'Histórico',workspace:'Plano e equipe',platform:'Plataforma'};
...
function ensureSaasSections() {
  ...
  if(main&&!$('#workspace')) main.insertAdjacentHTML('beforeend','<section id="workspace" class="admin-section hidden"></section><section id="platform" class="admin-section hidden"></section>');
}
